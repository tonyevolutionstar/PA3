...
public class ServerRequest extends Thread {
    ...
    private final int processRejectedFlag;
    private final int serverId;
    private final JTextArea ALLEXECUTEDTEXTAREA;
    private final JLabel TOTALREQUESTPRO;
    private final ArrayList<String> allProcessedRequests;
